...
$ sudo -s
# cd
# git clone https://github.com/JNPRAutomate/automated_junos_configuration_backup_with_syslog_saltstack.git
# ls automated_junos_configuration_backup_with_syslog_saltstack
```
...
```
# cp automated_junos_configuration_backup_with_syslog_saltstack/master /etc/salt/master
```
So: 
...
```
# cp automated_junos_configuration_backup_with_syslog_saltstack/minion /etc/salt/minion
```
...
```
# cp automated_junos_configuration_backup_with_syslog_saltstack/pillars/* network_parameters/
...
```
# cp automated_junos_configuration_backup_with_syslog_saltstack/proxy /etc/salt/proxy
```
...
```
# cp automated_junos_configuration_backup_with_syslog_saltstack/templates/* network_model/
# cd network_model/
# git add .
...
```
# cp automated_junos_configuration_backup_with_syslog_saltstack/states/* network_model/
# cd network_model/
# git add *
...
```
# cp automated_junos_configuration_backup_with_syslog_saltstack/reactor.conf /etc/salt/master.d/
...
```
# cp automated_junos_configuration_backup_with_syslog_saltstack/reactor/* /srv/reactor/
# ls /srv/reactor/
